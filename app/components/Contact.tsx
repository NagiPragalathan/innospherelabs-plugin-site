            ...
            <div className="grid grid-cols-1 mt-12 sm:mt-16 lg:mt-20 lg:grid-cols-6 lg:gap-x-24 gap-y-12">
                ...
                <div className="lg:col-span-4">
                    <form action="#" method="POST" className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            <label className="text-base font-normal text-white"> Your name </label>
                            <div className="mt-2">
                                <input type="text" name="" id="" placeholder="Enter your full name" className="block w-full px-5 py-4 text-base font-normal text-white placeholder-gray-500 bg-black border border-gray-800 rounded-md focus:border-white focus:ring-white focus:ring-1" />
                            </div>
                        </div>

                        <div>
                            <label className="text-base font-normal text-white"> Your email </label>
                            <div className="mt-2">
                                <input type="email" name="" id="" placeholder="Enter your email address" className="block w-full px-5 py-4 text-base font-normal text-white placeholder-gray-500 bg-black border border-gray-800 rounded-md focus:border-white focus:ring-white focus:ring-1" />
                            </div>
                        </div>

                        <div className="sm:col-span-2">
                            <label className="text-base font-normal text-white"> What kind of service are you looking for? </label>
                            <div className="mt-2">
                                <select name="" id="" className="block w-full py-4 pl-5 pr-10 text-base font-normal text-white placeholder-gray-500 bg-black border border-gray-800 rounded-md focus:border-white focus:ring-white focus:ring-1">
                        ...
                        <div className="sm:col-span-2">
                            <label className="text-base font-normal text-white"> Message </label>
                            <div className="mt-2">
                                <textarea name="" id="" placeholder="Write your message" className="block w-full px-5 py-4 text-base font-normal text-white placeholder-gray-500 bg-black border border-gray-800 rounded-md resize-y focus:border-white focus:ring-white focus:ring-1"></textarea>
                            </div>
                        </div>
